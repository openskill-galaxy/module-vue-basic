    ...
    <div className="space-y-10">
      <section className="text-center py-8">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <button onClick={() => setShowSpeedRun(true)} className="btn-ghost text-cyan-600 dark:text-cyan-300 border-cyan-500/30" type="button">
            ⚡ 60s 极速刷题赛
          </button>
          <button onClick={() => setShowCert(true)} className="btn-ghost text-amber-600 dark:text-amber-300 border-amber-500/30" type="button">
            🎓 查看通关结业证书
          </button>
        </div>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => setShowCert(true)} className="text-xs text-amber-600 dark:text-amber-400 hover:underline">
            🎓 生成官方认证证书
          </button>
        </div>
